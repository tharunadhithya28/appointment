            ...
            {props.items.map((eachItem) => {
              ...
              return (
                <tr className="items-start content-start" key={eachItem.id}>
                  ...
                  <td className={` sm:px-2 sm:py-2 lg:px-10 lg:py-6 ${isDark ? "text-white" : "text-slate-500"}`}> <div className="flex items-center gap-2">  <CiCalendarDate size={22} /> {reqDate}
                  </div>  </td>
                  <td className={`  sm:px-2 sm:py-2 lg:px-10 lg:py-6 ${isDark ? "text-white" : "text-slate-500"}`}> <div className="flex items-center gap-2"> <GoClock size={22} /> {eachItem.appointmentTime}
                  </div> </td>
                  <td className={`  sm:px-2 sm:py-2 lg:px-10 lg:py-6 ${isDark ? "text-white" : "text-slate-500"}`}> <div className="flex items-center gap-2"> {index === 3 || index === 4 ? (<GiAlliedStar size={22} color={"orange"} />) : (<GiAlliedStar size={22} color={"green"} />)} {eachItem.doctor}
                  </div>  </td>
                  ...
                  <td className={`  sm:px-2 sm:py-2 lg:px-10 lg:py-6 ${isDark ? "text-white" : "text-slate-500"}`}> <span> <BsThreeDotsVertical size={22} /></span> </td>
                </tr>
              )
            })}
          </tbody>
